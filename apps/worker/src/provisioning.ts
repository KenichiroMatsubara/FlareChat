...
CREATE TABLE IF NOT EXISTS rules (id TEXT PRIMARY KEY, organization_id TEXT NOT NULL, name TEXT NOT NULL, status TEXT NOT NULL, source_list_id TEXT, recipient_list_id TEXT, line_list_id TEXT, schedule_minutes INTEGER NOT NULL DEFAULT 5, require_attendance INTEGER NOT NULL DEFAULT 0, deadline_days_before INTEGER, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);
...
CREATE TABLE IF NOT EXISTS attendance (event_id TEXT NOT NULL, recipient_item_id TEXT NOT NULL, status TEXT NOT NULL DEFAULT 'unanswered', comment TEXT NOT NULL DEFAULT '', token TEXT NOT NULL UNIQUE, updated_at TEXT NOT NULL, PRIMARY KEY(event_id, recipient_item_id));
CREATE TABLE IF NOT EXISTS jobs (id TEXT PRIMARY KEY, kind TEXT NOT NULL, payload TEXT NOT NULL, state TEXT NOT NULL DEFAULT 'pending', attempts INTEGER NOT NULL DEFAULT 0, available_at TEXT NOT NULL, last_error TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);
