...
export const api = {
  ...
  scheduledTaskReminders: (accountId: string): Promise<TaskReminder[]> => request(account(accountId, '/task-reminders/schedule')),
  ...
  scheduledAttendanceReminders: (accountId: string): Promise<AttendanceReminder[]> => request(account(accountId, '/attendance-reminders/schedule')),
