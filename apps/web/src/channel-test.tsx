...
export const ContactChannelTest = ({ accountId }: { accountId: string }) => {
  ...
  return <section className="test-card">
    <h2>この連絡先に届くか試す</h2>
    <span>Contact が持っている Channel Handle を宛先にします。Automation や MCP Server と同じ経路で 1 通だけ送ります。抑止期間は無視されるので、同じ文面を続けて試せます。LINE は 5 通までを 1 リクエストにまとめるので、複数通にすればその挙動もそのまま確かめられます。</span>
